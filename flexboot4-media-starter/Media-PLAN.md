...
- 通过 `flexboot4-media-starter/src/main/resources/db/flexboot4-migration/media/postgresql` 下的 Flyway 脚本维护表结构和菜单数据，菜单新增 `视频中心/流媒体服务/视频网关/视频设备/分屏展示/国标级联`，权限码统一使用 `media:*`。
